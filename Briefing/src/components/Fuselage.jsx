...
const Fuselage = () => {
  return (
    <div className="relative flex">
        <div className="relative flex-row h-screen w-screen bg-center  bg-cover">
            

            <div className='absolute top-[16%] left-[10%] flex flex-row border-red-500 w-210 h-170 overflow-scroll text' style={{ lineHeight: '1' }}>
            ...
            <div className='absolute flex flex-row top-[53%] left-[8%] border-2 border-gray-500 border-solid w-226 h-150'>
