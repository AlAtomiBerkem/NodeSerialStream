...
export const QuizCompleted = () => {
    ...
    const { questions, currentQuestionIndex, userAnswers, missedQuestions } =
        useSelector((state) => state.quiz);

    const { uiState, handleSelect, handleLeftBtnClick, handleRightBtnClick } =
        useButtonLogic();
    ...
    useEffect(() => {
        ...
        handleSelect(
            currentAnswer ? (currentAnswer.userAnswer ? 'true' : 'false') : null
        );
